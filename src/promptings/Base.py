...
class BaseStrategy(object):
    def __init__(
        ...
        # Add dataset type detection
        self.dataset_type = self._detect_dataset_type()
    
    def _detect_dataset_type(self) -> str:
        """Detect the type of dataset being used"""
        if hasattr(self.data, '__class__'):
            ...
            if 'LiveCodeBench' in class_name:
                ...
                return 'humaneval'
            elif 'MBPP' in class_name:
                return 'mbpp'
            elif 'XCode' in class_name:
                return 'xcode'
            elif 'APPS' in class_name:
                return 'apps'
            elif 'CodeContest' in class_name:
                return 'codecontest'
        return 'unknown'
    
    def is_livecodebench(self) -> bool:
        """Check if the current dataset is LiveCodeBench"""
        return self.dataset_type == 'livecodebench'
    
    def is_competitive_programming(self) -> bool:
        """Check if the current dataset is competitive programming focused"""
        return self.dataset_type in ['livecodebench', 'apps', 'codecontest', 'xcode']
